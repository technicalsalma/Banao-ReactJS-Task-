...
import Sarah from '../assest/images/Rectangle 3 (6).png'
...
const Job = () => {
    return (
        ...
        <div class="card-body">
          ...
          <h4 class="fw-bold" style={{'width':'600px',}}>Software Developer</h4>
          <img src={dote} alt=''className='mt-3 img-fluid' style={{'width':'18px', 'height': '5px'}}/>
          </div>
          ...
          <div className='d-flex justify-content-between mt-3'>
              ...
              <h4 className='ps-2'>Joseph Gray</h4>
              </div>
              <div className='d-flex align-items-center'>
